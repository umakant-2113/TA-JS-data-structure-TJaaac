...
character.great = function (charactaerName, title) {
  alert(`I am ${character.charactaerName} and my title is ${character.title}`);
};
character.great();
...
character.great = function (charactaerName, title) {
  alert(
    `She is ${character.charactaerName} and her title is ${character.title}`
  );
};
character.great();
...
character.isAdult = character_Age > 18 ? true : false;
...
changeIsAdult = !(character_Age > 18) ? true : false;
...
charecter[keyName] = "Maisie Williams";
